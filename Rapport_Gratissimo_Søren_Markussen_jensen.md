...
Hovedopgaven er funktionelt komplet med minor styling choices missing men alt funktionalitet og den valgrie opgave hvor jeg valgte pagination er færdig lavet. 
...
Appen bruger en delt tilstand om brugeren er logget ind. Vi bruger en ref i auth.js, alle filer der importere den bruger den samme ref.
Vi slipper for at bruge pinia, da jeg stadig ikke er bekendt med det, og at vi ikke skal være depended på et outside library men vi har det in house.
...
#### Rettelse i API'et:
Jeg valgte at fjerne authorize fra newsletter, da Tilmeldingen til nyhedsbrevet står i footeren på alle sider, i footeren også for folk der ikke er logget ind. Jeg fjernede authorize fra newsletter i API/src/routes/newsletterSubscriberRoutes.ts
...
Udover min gennemgang af projektet vil jeg gå komme ind på:
...
Jeg brugte dog main/dev/feature branches og enkelte hotfix branches.
...
### Mandag
![Start](Monday/StartMonday.png)
![Slut](Monday/EndMonday.png)

### Tirsdag
![Start](Tuesday/StartTuesday.png)
![Slut](Tuesday/EndTuesday.png)

### Onsdag
![Start](Wednesday/StartOfWednesday.png)
![Slut](Wednesday/EndOfWednesday.png)

### Torsdag
![Start](Thursday/StartThursday.png)
![Slut](Thursday/EndThursday.png)

### Fredag
![Start](Friday/StartFriday.png)
![Slut](Friday/EndFriday.png)